...
class _AddNewLeadScreenState extends State<AddNewLeadScreen> {
                ...
                children: [
                  ...
                  Autocomplete<String>(
                    optionsBuilder: (textEditingValue) {
                      ...
                      return _serviceManager.services.where((service) => service
                          .toLowerCase()
  ...
  void _createLead() {
    ...
    if (_selectedService != null &&
        ...
        !_serviceManager.services.contains(_selectedService)) {
    ...
    final lead = Lead(
      ...
      address: _showContactForm && _addressController.text.isNotEmpty
          ? _addressController.text
          : null,
      country: _showContactForm ? _selectedCountry : null,
      state: _showContactForm && _stateController.text.isNotEmpty
          ? _stateController.text
          : null,
      city: _showContactForm && _cityController.text.isNotEmpty
          ? _cityController.text
          : null,
      zip: _showContactForm && _zipController.text.isNotEmpty
          ? _zipController.text
          : null,
