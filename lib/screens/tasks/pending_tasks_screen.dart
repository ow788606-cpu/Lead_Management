    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Column(
          ...
          children: [
            Text('Pending Tasks', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 18)),
            SizedBox(height: 2),
            Text('Tasks that are pending completion', style: TextStyle(color: Colors.grey, fontSize: 12, fontWeight: FontWeight.normal)),
          ],
        ),
        actions: [
          IconButton(
          ...
          child: Container(
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: const Row(
                    children: [
                      ...
                      Expanded(flex: 2, child: Text('Due Date', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13))),
                ...
                const Expanded(
                  child: Center(
                    child: Text('No pending tasks found.', style: TextStyle(color: Colors.grey, fontSize: 14)),
                  ),
                ),
                Container(
                  padding: const EdgeInsets.all(16),
